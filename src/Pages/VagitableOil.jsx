...
export default function Vegitbl() {
  return (
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:grid md:grid-cols-2 items-center w-full">
            ...
            <div className="text-center md:text-left -mt-6 md:mt-0">
              <h1 className="text-xl md:text-3xl font-bold text-green-900 mb-3">
                KisanChoice Refined Rice Bran Oil
              </h1>
              ...
              <p className="text-gray-700 text-sm md:text-lg leading-relaxed">
                ...
                is a premium cooking oil extracted from rice bran, known for 
                its heart-friendly properties. Rich in natural antioxidants 
                like oryzanol, it helps manage cholesterol levels while 
                providing a light taste for everyday cooking.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-xl md:text-3xl font-bold text-green-900 mb-4">
              Heart-Friendly & Nutritious Oil
            </h2>

            <p className="text-gray-600 mb-6 text-sm md:text-lg">
              KisanChoice Rice Bran Oil is widely known as a heart-friendly oil 
              due to its balanced fatty acids and presence of oryzanol. 
              It helps reduce bad cholesterol (LDL) while maintaining good cholesterol (HDL). 
              Perfect for deep frying, sautéing, and daily cooking, it keeps your food 
            ...
            <div className="flex justify-center md:justify-start gap-6 flex-wrap">
              ...
              <div className="flex flex-col items-center text-center w-24">
                ...
                <p className="text-xs mt-2">Rice Bran Extract</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center w-24">
                ...
                <p className="text-xs mt-2">Perfect for Frying</p>
              </div>
